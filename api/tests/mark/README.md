...
**La mesure de référence, au 15/09/2026 sur `chantier/etat-ouverture` (à reporter à la fusion) : 476 tests,
...
l'écran, **380 avec la conversion des nombres dictés** (15/09), **476 avec l'état d'ouverture** (15/09, branche, après relecture). C'est ce nombre-là que la procédure de montée de version prend comme base —
