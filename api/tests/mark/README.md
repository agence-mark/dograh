...
**La mesure de référence, au 14/09/2026 au SOIR : 350 tests, tous verts avec les patchs.**
...
transcription, **350 après l'exposition des réglages Pipecat** (14/09). C'est ce nombre-là que la procédure de montée de version prend comme base —
