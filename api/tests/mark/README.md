...
**La mesure de référence, au 16/09/2026 sur `chantier/montee-amont-23d22b95` (montée de version
amont, avant fusion) : 527 tests, tous verts avec les patchs.** 483 sur `mark/deploiement`
...
`test_camb_tts_integration.py`, qui dépend d'un état posé par un autre fichier). Les deux modes se
