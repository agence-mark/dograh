...
async def save_preferences(
    ...
    # Only when it is sent: upstream's partial update keeps the stored address
    # when the screen leaves it out (4e6cb22b).
    if request.adresse_etablissement is not None:
        try:
